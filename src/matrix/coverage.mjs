export function buildCoverage({ surfaces, scenarios, states, profiles }) {
  ...
  return {
    ...
    profiles: profiles.map((profile) => profileCoverage(profile, { scenarios, states }))
  };
}

function profileCoverage(profile, { scenarios, states }) {
